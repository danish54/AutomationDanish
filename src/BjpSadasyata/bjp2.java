...
//String BoothNumber=r.getCell(10).getStringCellValue();
...
/*try {
	ermsg = driver.findElement(By.className("error-message")).getText();
	//System.out.println("logggggggggg     "+ermsg);
...
if(errormsg.contains("This mobile number and membership id registration is already done") 
		|| errormsg.contains("Mobile number and membership id does not match") 
		...
		)
{
	...
	driver.findElement(By.xpath("//input[@id='ref_mobile']")).sendKeys(mno);  
	 ...
	 //driver.findElement(By.xpath("//input[@id='captcha_sum']"));
